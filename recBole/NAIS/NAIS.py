...
from recbole.model.general_recommender import SGL
...
if __name__ == '__main__':
    ...
    config_path = 'SGL.yaml'  # set your desired config file path
    ...
    model_path = f'models/NAIS{epochs}.pt'  # set your desired file path and name
    torch.save(model.state_dict(), model_path)
    
    # model evaluation
    test_result = trainer.evaluate(test_data)
    json.dump(test_result, open(f'../results/NAIS{epochs}.json', 'w'))